...
local MINOR_VERSION = tonumber(string.sub("$Revision: 58622 $", 12, -3))
...
BabbleSpell:RegisterTranslations("deDE", function()
	return {
		...
		["Create Firestone (Greater)"] = "Feuerstein herstellen (Gr\195\182sser)",
		...
		["Create Healthstone (Greater)"] = "Gesundheitsstein herstellen (Gr\195\182sser)",
		...
		["Create Soulstone (Greater)"] = "Seelenstein herstellen (Gr\195\182sser)",
		...
		["Create Spellstone (Greater)"] = "Zauberstein herstellen (Gr\195\182sser)",
		...
		["Hellfire Superiority"] = "\195\188berlegenheit des H\195\182llenfeuers",
		...
		["Improved Overpower"] = "Verbessertes \195\188berw\195\164ltigen",
		...
		["Opening"] = "\195\182ffnen",
		["Opening - No Text"] = "\195\182ffnen - Kein Text",
		["Opportunity"] = "G\195\188nstige Gelegenheit",
		["Overpower"] = "\195\188berw\195\164ltigen",
		...
		["Perceived Weakness"] = "Schw\195\164che aufdecken",
		...
		["Reckless Charge"] = "R\195\188cksichtsloser Sturmangriff",
		...
		["Surprise Attacks"] = "\195\188berraschungsangriffe",
		["Survivalist"] = "\195\188berlebensk\195\188nstler",
