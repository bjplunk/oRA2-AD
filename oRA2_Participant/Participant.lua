...
local revision = tonumber(("$Revision: 658 $"):match("%d+"))
...
local spells = {
   [(GetSpellInfo(26994))] = true, -- Rebirth
   [(GetSpellInfo(25435))] = true, -- Resurrection
   [(GetSpellInfo(20773))] = true, -- Redemption
   [(GetSpellInfo(25590))] = true, -- Ancestral Spirit
